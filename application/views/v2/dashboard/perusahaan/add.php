         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1 class="m-0">TAMBAH DATA PERUSAHAAN BARU</h1>
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                           <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard'); ?>">DASHBOARD</a></li>
                           <li class="breadcrumb-item"><a href="<?php echo base_url('perusahaan'); ?>">PERUSAHAAN</a></li>
                     ...
                     <div class="col-lg-12">
                        <div class="card" id="card-perusahaan">
                           <div class="card-header">
                              <h3 class="card-title">ISI DATA PERUSAHAAN</h3>
                           </div>
                           <div class="card-body">
                              <!-- form start -->
                              <form class="form-horizontal" id="form_perusahaan" action="<?php echo base_url('perusahaan/save'); ?>" method="POST">
                                 <div class="card-body">
