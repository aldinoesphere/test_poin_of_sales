      ...
      <!-- AdminLTE -->
      <script src="<?php echo base_url('assets/v2/dist/js/adminlte.min.js'); ?>"></script>
      <!-- OPTIONAL SCRIPTS -->
      <script src="<?php echo base_url('assets/v2/plugins/flot/jquery.flot.js'); ?>"></script>
      <script src="<?php echo base_url('assets/v2/plugins/flot/plugins/jquery.flot.resize.js'); ?>"></script>
      <script src="<?php echo base_url('assets/v2/plugins/flot/plugins/jquery.flot.pie.js'); ?>"></script>
