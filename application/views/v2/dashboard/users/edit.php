                     ...
                     <div class="col-lg-12">
                        <div class="card" id="card-users">
                           ...
                           <div class="card-body">
                              ...
                              <form class="form-horizontal" id="form_users" action="<?php echo base_url('users/update/'.$value->id); ?>" method="POST">
                                 <div class="card-body">
                                    <div class="form-group row">
                                       <label for="name" class="col-sm-4 col-form-label">NAMA USER</label>
                                       <div class="col-sm-8">
                                          <input type="text" class="form-control" name="name" id="name" value="<?php echo $value->name; ?>" placeholder="NAMA USER">
                                       </div>
                                    </div>
                                    <div class="form-group row">
