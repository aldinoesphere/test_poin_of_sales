...
class Users extends CI_Controller
{
    ...
    {
        $users = $this->users_model->getAllAdminLogin();
        $data['users'] = $users;
        $data['required_style'] = [
        ...
        $this->load->view('v2/dashboard/users/view', $data);
    ...
    public function add()
    {
        ...
        $this->load->view('v2/dashboard/header', $data);
        $this->load->view('v2/dashboard/users/add', $data);
        $this->load->view('v2/dashboard/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('v2/dashboard/header', $data);
        $this->load->view('v2/dashboard/users/edit', $data);
        $this->load->view('v2/dashboard/footer');
    }
    ...
    public function save()
    {
        ...
        $save = $this->users_model->add($data);
    ...
    public function update($id)
    {
        ...
        $save = $this->users_model->update($data, $id);
    ...
    {
        $deleted = $this->users_model->delete($id);
        if ($deleted) {
            $result = [
                'status' => 'true',
                'messageType' => 'success',
