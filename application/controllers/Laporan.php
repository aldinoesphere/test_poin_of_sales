...
class Laporan extends CI_Controller
{
    ...
    public function details($no_nota)
    {

        $report_data = $this->laporan_model->get_details_penjualan($no_nota);

        $data['details_penjualan'] = $report_data;
        $data['required_style'] = [
            'plugins/daterangepicker/daterangepicker.css',
            'plugins/datatables-bs4/css/dataTables.bootstrap4.min.css',
            'plugins/datatables-responsive/css/responsive.bootstrap4.min.css',
        ...
        $this->load->view('v2/dashboard/header', $data);
        $this->load->view('v2/dashboard/laporan/details_penjualan', $data);
        $this->load->view('v2/dashboard/footer');
    }
